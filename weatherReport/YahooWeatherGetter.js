...
function getYahooWeatherForecast(data){
    if(data){
        ...
        if(YahooWeatherGetter.showArea){
            ...
            "<img src='img/" + icon + ".png' class='current-weather-img' id='w_img2'>"+
            ...
            for(var i = 0; i < 3; i++) {
                ...
                if(YahooWeatherGetter.showArea){
                    ...
                    if(i == 0){
                        ...
                        "<img src='img/" + icon1 + ".png' class='weather-img' id='w_img1'>"+
                        ...
                        "<img src='img/" + icon1 + ".png' class='weather-img' id='w_img2'>"+
                        ...
                        "<img src='img/" + icon1 + ".png' class='weather-img' id='w_img3'>"+
